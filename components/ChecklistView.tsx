...
interface ChecklistViewProps {
  ...
  setEnabledSectors: React.Dispatch<React.SetStateAction<string[]>>;
  checkedItems: string[]; // Contains Group IDs
  setCheckedItems: React.Dispatch<React.SetStateAction<string[]>>;
}

export const ChecklistView: React.FC<ChecklistViewProps> = ({ 
  enabledSectors, setEnabledSectors, checkedItems, setCheckedItems 
}) => {
  ...
  const toggleEnabled = (sectorId: string) => {
    if (enabledSectors.includes(sectorId)) {
      setEnabledSectors(prev => prev.filter(id => id !== sectorId));
    } else {
      setEnabledSectors(prev => [...prev, sectorId]);
